import os
import requests
from gpt.chat_prompt import gpt_api
import openai
import os
import json
...
def gpt_example_run():
    ...
    tmp_api.prompt(
        text="Give me two true or false coding question answer pairs based on python, return it in json format, keep the difficulty level on very hard, provide examples for each question")
...
# our_api.init_question(profile=profile, pdf_path=pdf, opt_context=opt_context, key_path=key_path)
